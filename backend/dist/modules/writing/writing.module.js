    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: writing_schema_1.WritingPrompt.name, schema: writing_schema_1.WritingPromptSchema },
                { name: writing_schema_1.WritingSubmission.name, schema: writing_schema_1.WritingSubmissionSchema },
            ]),
        ],
        controllers: [writing_controller_1.WritingController],
        providers: [writing_service_1.WritingService],
        exports: [writing_service_1.WritingService],
    })
], WritingModule);
